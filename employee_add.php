...
//找尋帳號是否已經註冊
$query_RecFindUser = "SELECT em_username FROM employee_member WHERE em_username='{$_POST["ew_username"]}'";
$RecFindUser=$db_link->query($query_RecFindUser);
if ($RecFindUser->num_rows>0){
//比對帳號密碼的預備語法
$query_RecLogin = "SELECT em_username, em_passwd FROM employee_member WHERE em_username=?";
...
//輸入資料的各項連結位置
$query_insert = "INSERT INTO employee_work (ew_month, ew_day, ew_time, ew_roomnumber, ew_roomcondition, ew_ip_location,  ew_username, ew_name, ew_jointime) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())";
$stmt = $db_link->prepare($query_insert);
$stmt->bind_param("ssssssss",$ew_month, $ew_day, $ew_time, $ew_roomnumber, $ew_roomcondition, $ew_ip_location, $ew_username, $ew_name);
$ew_month = GetSQLValueString($_POST["ew_month"], 'string');
$ew_day = GetSQLValueString($_POST["ew_day"], 'string');
$ew_time = GetSQLValueString($_POST["ew_time"], 'string');
$ew_roomnumber = GetSQLValueString($_POST["ew_roomnumber"], 'string');
$ew_roomcondition = GetSQLValueString($_POST["ew_roomcondition"], 'string');
                  ...
                  <div class="dataDiv">
                    ...
                    <p><strong>使用帳號</strong>：
                      ...
                      <td width="400">
                        ...
                        <div class="regbox">
                          <p class="heading">工作資料</p>
                          <p><strong>負責人員</strong>：
                            <input name="ew_name" type="text" class="normalinput" id="ew_name" required>
                          <font color="#FF0000">*</font><br></p>
                          <p><strong>月份</strong>：
                            <input name="ew_month" type="text" class="normalinput" id="ew_month" required>
                          <font color="#FF0000">*</font><br></p>
                          <p><strong>日期</strong>：
                            <input name="ew_day" type="text" class="normalinput" id="ew_day" required>
                          <font color="#FF0000">*</font><br></p>
                          <p><strong>時間</strong>：
                            <input name="ew_time" type="text" class="normalinput" id="ew_time" required>
                          <font color="#FF0000">*</font><br></p>
                          <p><strong>房間號碼</strong>：
                            <input name="ew_roomnumber" type="text" class="normalinput" id="ew_roomnumber" required>
                          <font color="#FF0000">*</font><br></p>
                          <p><strong>特殊狀況報告</strong>：
                            <input name="ew_roomcondition" type="text" class="normalinput" id="ew_roomcondition">
                          <font color="#FF0000">*</font><br></p>
                        ...
                        <div class="boxbl"></div><div class="boxbr"></div></div></td>
                      </tr>
                      </form>
                    </table></td>
                  </tr>
